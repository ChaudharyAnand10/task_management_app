...
class PriorityTaskScreen extends StatefulWidget {
  ...
  @override
  State<PriorityTaskScreen> createState() => _PriorityTaskScreenState();
}

class _PriorityTaskScreenState extends State<PriorityTaskScreen> {
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: Obx(
              () => ListView.builder(
                itemCount: taskController.prioritywisetask.length,
                itemBuilder: (context, index) {
                  final task = taskController.prioritywisetask[index];
